    ...
    <div class="container-fluid">
        ...
        <div class="row py-3">
            <div class="col mx-auto d-flex align-items-center">
                <h3 class="mx-auto mt-3">Agregar Habitante <br></h3>
            </div>
        </div>
        <div class="row py-3">
            <div class="col">
                <div class="justify-content-center align-items-center vh-200 vw-200 w-25 mx-auto">
                    <form method="post" action="">
                        ...
                        <a href="principalHabitante.php" type="submit" class="btn btn-success d-flex d-flex justify-content-center align-items-center mx-auto mt-4">Agregar</a>
                    </form>
                </div>
            </div>
        </div>
